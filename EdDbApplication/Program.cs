...
namespace EdDbApplication
{
    class Program
    {
        ...
        static void TestConnection()
        {
            ...
            itWorked = studentsCtrl.Delete(65);
        ...
        static void Test1()
        {
            var connStr = @"server=localhost\sqlexpress;database=EdDb;trusted_connection=true;";//server= ;database= ;trusted_connection= ;
            ...
            while (reader.Read())
            {
                ...
                student.StateCode = reader["Lastname"].ToString();
